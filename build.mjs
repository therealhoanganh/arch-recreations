...
// has to travel inside main.js -- otherwise main.js loads lib/recreations.js from a
// folder that was never installed and the plugin dies on load. esbuild bundles
// recreations.js together with the image.js it requires into a single
...
const result = await build({
  entryPoints: ['lib/recreations.js'],
  bundle: true,
  write: false,
  format: 'iife',
  globalName: 'ARCH_LIB',
